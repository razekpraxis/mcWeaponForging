...
public class WeaponBlocks {
    ...
    public static final RegistryObject<Block> SAPPHIRE_STAIRS = registerBlock("sapphire_stairs",
            () -> new StairBlock(() -> WeaponBlocks.SAPPHIRE_BLOCK.get().defaultBlockState(),
    ...
    public static final RegistryObject<Block> SAPPHIRE_FENCE_GATE = registerBlock("sapphire_gate",
            () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK), SoundEvents.CHAIN_BREAK, SoundEvents.CHAIN_HIT));
