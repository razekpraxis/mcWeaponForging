...
public class WeaponForgeMenu extends AbstractContainerMenu {
    public final WeaponForgeEntity blockEntity;
    ...
    public WeaponForgeMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data){
        super(WeaponMenuTypes.WEAPON_FORGE_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((WeaponForgeEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, WeaponBlocks.WEAPON_FORGE.get());
    }
